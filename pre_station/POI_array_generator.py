...
POI_array = np.empty( (station_num, 10, grid_side_length, grid_side_length) )
...
for index in range(1, station_num + 1):
    ...
    POI_array[index - 1] = my_map.copy()

print("POI_array:")
print(POI_array)
print("POI_array.shape:")
print(POI_array.shape)

np.save("npy_files/POI_array.npy", POI_array)
