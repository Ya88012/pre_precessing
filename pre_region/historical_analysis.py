...
df_train = np.load('npy_files/training_vdata_array.npy')
df_test = np.load('npy_files/testing_vdata_array.npy')
    ...
    for y in range(20):
        for day in range(0, 7):
            for hour in range(18, 37):
                ...
                train_arriving_flow_list = df_train[ training_weekday_start_time_slot[day] + hour :: 48 * 7, x, y, 0]
                train_departing_flow_list = df_train[ training_weekday_start_time_slot[day] + hour :: 48 * 7, x, y, 1]

                test_arriving_flow_list = df_test[ testing_weekday_start_time_slot[day] + hour :: 48 * 7, x, y, 0]
                test_departing_flow_list = df_test[ testing_weekday_start_time_slot[day] + hour :: 48 * 7, x, y, 1]
